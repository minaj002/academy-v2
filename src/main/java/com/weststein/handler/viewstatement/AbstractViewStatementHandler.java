...
public abstract class AbstractViewStatementHandler<T> {
    ...
    public abstract T handle(Long id, Long cardholderId, LocalDateTime from, LocalDateTime to, TransactionType type, int size, int page);

    public ViewStatementModel getStatement(Long id, LocalDateTime from, LocalDateTime to, TransactionType type, int size, int page) {
