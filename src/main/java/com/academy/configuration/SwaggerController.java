...
public class SwaggerController {
    ...
    public Docket serviceApiSecured() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.academy.rest.controller.secured"))
                .build()
    ...
    public Docket serviceApiLogin() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(apiInfo())
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.academy.rest.controller.unsecured"))
                .build()
                .useDefaultResponseMessages(false)
                .enableUrlTemplating(false)
                ;
